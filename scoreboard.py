...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        # Account output in the upper right part of the screen
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render("Record: " + high_score_str, True, self.text_color,
                                                 self.ai_settings.bg_color)
    ...
    def show_score(self):
        """Displays the current score, record and the number of remaining ships."""
